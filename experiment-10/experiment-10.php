...
// Apply WP REST API example to create, update, and delete a new post 
// Will not work until proper $api_url and api_header_args are suppled and 
// Register a custom page for your plugin
add_action( 'admin_menu', 'pdev_create_rest_menu' );
             
function pdev_create_rest_menu() {
             
    // Create custom top-level menu
    add_menu_page( 'Dean\'s REST API FUN', 'Dean\'s REST API',
...
function pdev_create_new_post() {
    ...
    if ( isset( $_POST['create-post'] ) ) {
        ...
        // Using Basic Auth, set the destination site username and password once WP Basic Auth plugin is installed there
        ...
        // Set the API URL to send the request, replace <ID> with post ID you wish to update
        $api_url = 'https://example.com/wp-json/wp/v2/posts/wp-json/wp/v2/posts/<ID>/';
        ...
        // Set the API URL to send the request, replace <ID> with post ID you wish to delete
        $api_url = 'https://example.com/wp-json/wp/v2/posts/wp-json/wp/v2/posts/<ID>/';
